...
**Annotation System Redesign (in progress):**
1. Move tag/note icons below verse (not in left margin)
2. Build new inline annotation menu: `Highlight | Note | Tag | Copy`
3. Highlight submenu: H1-H6 colours + X clear, U1-U6 underline + X clear
4. Tag submenu: active tags (tap remove), existing tags (tap add), new tag input + colour
5. Note submenu: text area with Delete | Save
6. Add copy verse to clipboard

**Then:**
7. Test full annotation flow on mobile
8. Theme selection page improvements (user mentioned for later)
