...
#### High Priority
1. **Annotation Visibility Modes** - On/Subtle/Off toggle (from ideas.md)
2. **Multiple Annotation Sets** - Study, Church, Personal with switcher
3. **Font Controls** - Size adjustment, OpenDyslexic option (dyslexia features)

#### Medium Priority
4. **Export Feature** - Download annotations as JSON
5. **PWA Setup** - Offline support, installable
...
1. Add annotation visibility modes (On/Subtle/Off)
2. Implement multiple annotation sets switcher
3. Add font controls (size, OpenDyslexic)
4. Test on mobile devices
5. Consider PWA setup
